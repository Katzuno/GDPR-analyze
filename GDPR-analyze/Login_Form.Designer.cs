namespace GDPR_analyze
{
    partial class Login_Form
    {
        ...
        private void InitializeComponent()
        {
			...
			this.login_bck_btn = new MaterialSkin.Controls.MaterialRaisedButton();
			this.SuspendLayout();
			// 
			// username_label
			// 
			...
			// login_bck_btn
			// 
			this.login_bck_btn.AutoSize = true;
			this.login_bck_btn.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.login_bck_btn.Depth = 0;
			this.login_bck_btn.FlatAppearance.BorderSize = 0;
			this.login_bck_btn.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.login_bck_btn.Icon = null;
			this.login_bck_btn.Location = new System.Drawing.Point(1008, 91);
			this.login_bck_btn.MouseState = MaterialSkin.MouseState.HOVER;
			this.login_bck_btn.Name = "login_bck_btn";
			this.login_bck_btn.Primary = true;
			this.login_bck_btn.Size = new System.Drawing.Size(66, 36);
			this.login_bck_btn.TabIndex = 12;
			this.login_bck_btn.Text = "BACK";
			this.login_bck_btn.UseVisualStyleBackColor = true;
			this.login_bck_btn.Click += new System.EventHandler(this.login_bck_btn_Click);
			// 
			// Login_Form
			// 
			...
			this.Controls.Add(this.login_bck_btn);
		...
		private MaterialSkin.Controls.MaterialRaisedButton login_bck_btn;
	}
}